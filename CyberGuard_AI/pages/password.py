...
def password_page(parent):
    ...
    Password is analyzed locally.
    The actual password is never saved in Reports.
    """
    ...
    strength_label.configure(
        text_color=STRENGTH_COLORS["MODERATE"],
        fg_color=STRENGTH_BG["MODERATE"]
    )
    ...
    def _render_history():
        ...
        for entry in history:
            ...
            ctk.CTkLabel(
                ...
                text=entry["strength"],
                font=(FONT, 13, "bold"),
                text_color=STRENGTH_COLORS.get(
                    entry["strength"],
                    TEXT_COLOR
                ),
                width=140,
    ...
    def _run_analysis():
        ...
        save_report(
            "Password Analyzer",
            "Password Analysis (password not stored)",
            score,
            risk,
            verdict,
            recommendation_text,
